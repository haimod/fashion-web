...
const handleLogin = async (e) => {
  ...
  return (
    <main className="relative h-screen w-full flex items-center justify-center p-4 md:p-0 bg-surface text-on-surface overflow-hidden">
      ...
      {/* Login Container */}
      <div className="relative z-10 w-full max-w-[480px] glass-panel p-8 md:p-12 shadow-[0px_10px_30px_rgba(26,28,28,0.06)] border border-outline-variant/10">
        ...
        <form onSubmit={handleLogin} className="space-y-8">
          ...
          <div className="relative">
            <div className="flex justify-between items-end mb-2">
              ...
              <Link to="/forgot-password" className="text-[0.65rem] font-bold uppercase tracking-[0.1rem] text-primary hover:text-on-primary-container transition-colors">
                Quên mật khẩu?
              </Link>
            </div>
            <div className="relative">
              ...
              />
              <button 
                className="absolute right-0 top-1/2 -translate-y-1/2 text-on-surface-variant/60 hover:text-on-surface" 
                type="button"
          ...
          {/* Primary CTA */}
          <button 
            className="w-full bg-primary hover:bg-surface-tint text-on-primary py-4 text-[0.75rem] font-bold uppercase tracking-[0.2rem] transition-all duration-300 shadow-[0px_4px_15px_rgba(124,87,45,0.2)]" 
            type="submit"
          >
            Đăng Nhập
          </button>
        ...
        <div className="mt-12">
          <div className="relative flex items-center justify-center mb-8">
            ...
            <span className="relative px-4 bg-transparent text-[0.6rem] font-bold uppercase tracking-[0.15rem] text-on-surface-variant">
              Hoặc tiếp tục với
            </span>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center py-4 border border-outline-variant/40 hover:bg-surface-container-low transition-colors duration-300 group">
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 md:left-12 md:translate-x-0 z-20">
        <div className="flex items-center space-x-4 bg-on-background text-surface px-6 py-3 shadow-xl">
