...
export default function EditProduct() {
    ...
    // 2. Kéo danh sách danh mục từ DB
    useEffect(() => {
            ...
            <form onSubmit={handleSubmit} className="bg-surface-container-lowest p-10 vibe-shadow grid grid-cols-2 gap-8 relative overflow-hidden">
                ...
                <div className="flex flex-col gap-6 relative z-10">
                    <div className="flex flex-col gap-2">
                        ...
                        <input value={formData.ma_sp} readOnly className="bg-surface-container-low border-b border-outline-variant/50 py-3 focus:outline-none font-medium text-sm text-outline-variant cursor-not-allowed uppercase" />
                    </div>
                ...
                <div className="flex flex-col gap-6 relative z-10">
                    <div className="flex flex-col gap-2">
                        ...
                        <input required type="number" min="0" name="gia_ban" value={formData.gia_ban} onChange={handleChange} className="bg-transparent border-b border-outline-variant/50 py-3 focus:border-primary outline-none font-medium text-sm" />
                    </div>

                    <div className="flex flex-col gap-2">
                        <label className="text-[0.65rem] font-bold tracking-[0.2rem] uppercase text-outline">Số lượng tồn kho</label>
                        <input required type="number" min="0" name="so_luong" value={formData.so_luong} onChange={handleChange} className="bg-transparent border-b border-outline-variant/50 py-3 focus:border-primary outline-none font-medium text-sm" />
                    </div>
                ...
                <div className="col-span-2 mt-4 flex flex-col gap-2 relative z-10">
                    ...
                    <textarea name="mo_ta" value={formData.mo_ta} onChange={handleChange} rows="3" className="bg-transparent border-b border-outline-variant/50 py-3 focus:border-primary outline-none font-medium text-sm resize-none"></textarea>
